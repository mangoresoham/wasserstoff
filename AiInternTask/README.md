...
The following table presents the **ROUGE-1 F1 scores** for various summarization models tested on the [`test.txt`](AiInternTask/Models/test.txt) document. The summary generated by **GPT-4o** was used as the reference summary for evaluating the performance of these models.
