...
The following table presents the **ROUGE-1 F1 scores** for various summarization models tested on the `test.txt` document. The summary generated by **GPT-4** was used as the reference summary for evaluating the performance of these models.
